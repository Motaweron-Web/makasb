...
@section('page_name')
    {{trans('site.tiktok')}} | {{trans('site.makasb')}}
@endsection
@section('site_css')
        ...
        <div class="Home Followers">
            <div class="container sectionHight">
                <div class="row  align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="shareBox">
                            <h3 class="fs-4 fw-bold TitlePage"> {{trans('site.TikTok Video Like')}} </h3>
                            <h3 class="fs-5 fw-bold TitlePage2">{{trans('site.get FREE points by liking')}} </h3>
                            <p class="fs-6 mt-lg-3 lh-lg">
                                {{trans('site.To get free points by following others TikTok accounts click on the "follow" button')}}

                            </p>
                            <div>
                                <button class="mainButton TikTokss"><a href="{{route('publishMySite')}}">
                                   {{trans('site.Get TikTok Video Like')}}
                                    </a></button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <button data-site-id={{$row->id}} data-url="{{$row->url}}"
                                                        class="Deletes TikTokss customBtn myShareBtn">{{trans('site.share')}}
                                                </button>
                                            </div>
                                        </td>
                                        <td>
