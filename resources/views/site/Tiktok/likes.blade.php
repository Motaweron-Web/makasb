            ...
            <div class="container sectionHight">
                <div class="row  align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div><img src="{{asset('assets/site')}}/img/Social ideas-cuate.svg" alt=""></div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="shareBox">
                            <h3 class="fs-4 fw-bold TitlePage"> TikTok Video Like</h3>
                            <h3 class="fs-5 fw-bold TitlePage2">get FREE points by liking, following and etc. other profiles -
                                posts </h3>
                            <p class="fs-6 mt-lg-3 lh-lg">
                                To get free points by following other's TikTok accounts click on the "follow" button,
                                then the account will be opened with popUp and after following CLOSE the popUp yourself.
                                The users who don't close manually the popUp, will not receive points.


                            </p>
                            <div>
                                <button class="mainButton TikTokss"><a href="{{route('publishMySite')}}">
                                        Get TikTok Video Like
                                    </a></button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <button data-site-id={{$row->id}} data-url="{{$row->url}}"
                                                        class="Deletes TikTokss customBtn myShareBtn">Share
                                                </button>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-center">
                                                <button class="Delete TikTokss customBtn skipBtn"
