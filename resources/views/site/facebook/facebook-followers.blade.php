        ...
        <div class="Home Followers">
            <div class="container sectionHight">
                <div class="row  align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="shareBox">
                            <h3 class="fs-4 fw-bold TitlePage"> Facebook Followers</h3>
                            ...
                            <div>
                                <button class="mainButton"><a href="Addsite.html">
            ...
            <div class="container">
                <h3 class="fs-4 fw-bold TitlePage">Wait 9-10 seconds after Follow/Like/Subscribe and then receive your reward</h3>
                @if($data->count())
                    <div class="table">
