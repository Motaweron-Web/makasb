            ...
            <div class="Home POstLike ">
                <div class="container sectionHight">
                    <div class="row  align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="shareBox">
                                <h3 class="fs-4 fw-bold TitlePage">{{trans('site.Facebook Page Likes')}} </h3>
                                <h3 class="fs-5 fw-bold">{{trans('site.For this section only - click the FOLLOW button if there is no LIKE button in the pop-up windowA')}}</h3>
