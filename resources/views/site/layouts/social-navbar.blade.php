<nav class="navbar navbar-expand-lg navbar-light navTop homenav">
    <div class="container">
        <a class="navbar-brand logo" href="#"><img class="LogoBrand" src="img/logo.png" alt="" /></a>
        <button class="navbar-toggler togglers" id="navbar-toggler" type="button" data-bs-toggle="collapse"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-3 mb-lg-0 navTopLink">
                <li class="nav-item">
                    <a class="nav-link me-3 " data-scroll="Home" aria-current="page" href="MySites.html">My Sites</a>
                </li>
                <li class="nav-item me-3">
                    <a class="nav-link" data-scroll="Features" href="#">Subscription</a>
                </li>
                <li class="nav-item me-3">
                    <a class="nav-link" data-scroll="coins" href="#">Buy Points</a>
                </li>
                <li class="nav-item dropdown ">
                    <a class="nav-link dropdown-toggle active Facebook" href="#" id="navbarDropdown" role="button"
                       data-bs-toggle="dropdown" aria-expanded="false"
                    >
                        <i class="fa-brands fa-facebook-square me-1"></i>Facebook
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item active" href="facbookshare.html">Facebook Share</a></li>
                        <li>
