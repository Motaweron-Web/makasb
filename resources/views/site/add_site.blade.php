            ...
            <div class="AddSiteTop">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="div">
                                <h3 class="fs-4 fw-bold">Here you can add or edit your content</h3>
                                <p class="fs-6 mt-lg-3 lh-lg">
                                    The higher the CPC of your site/page, the more likely you are to get it seen, which
                                    means that the rate of getting likes/followers will be high. You can add an
                                    unlimited
                                    number of sites/pages. Please read our Terms carefully again so you don't post
                                    content
            ...
            <div class="addSiteDown">
                <form action="{{route('publishMySite')}}" id="SiteForm">
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        <input type="number" name="total_clicks_limit" id="frist" disabled>
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        <input type="number" name="daily_clicks_limit" id="second" disabled>
